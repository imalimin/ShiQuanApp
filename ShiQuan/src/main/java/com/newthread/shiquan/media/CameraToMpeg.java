...
public class CameraToMpeg{
    private static final String TAG = "CameraToMpeg";
...
//    }
    ...
    private static class CameraToMpegWrapper implements Runnable {
        ...
        private CameraToMpeg cameraToMpeg;

        private CameraToMpegWrapper(CameraToMpeg cameraToMpeg) {
            cameraToMpeg = cameraToMpeg;
        }

        @Override
        public void run() {
            try {
                cameraToMpeg.encodeCameraToMpeg();
            } catch (Throwable th) {
                mThrowable = th;
            }
        }
         ...
         * Entry point.
         */
        public static void runTest(CameraToMpeg obj) throws Throwable {
