...
/**
 * Created by 翌日黄昏 on 2014/8/19.
 */

@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
public class EncodeVideoToMp4 {
    private static final String TAG = "EncodeVideoToMp4";
    ...
    public EncodeVideoToMp4(int mWidth, int mHeight) {
        this.mWidth = mWidth;
