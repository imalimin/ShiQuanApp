...
public class VideoEncoderFromBuffer {
	...
	private static final int BIT_RATE = 512 * 1024 * 8; // bit rate CameraWrapper.
	private int mWidth;
	private int mHeight;
	...
	@SuppressLint("NewApi")
	public VideoEncoderFromBuffer(int width, int height, File file) {
...
//				+ this.mHeight + ".mp4";
		...
		try {
			mMuxer = new MediaMuxer(this.file.toString(),
